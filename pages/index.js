  ...
  return (
    <div>
     <comp.Background />
      ...
      <MainMenuForm />
      <p className={multiClass([styles.centered, styles.subTitleComp])}> Follow <a target="_blank" rel="noopener noreferrer" style={{color: "#344DA8"}} href="https://twitter.com/Phrenemies1">Phrenemies!</a> on Twitter for updates</p>
      <InfoHolder />
    </div>
  )
}
